...
class ListarEnviosCampanha {
  async list(campanhaId: number, page: number, limit: number, filtros: FiltroEnvioAutomacao) {
    const response = await Api.get('campanha/envio', {
      params: {
        campanhaId,
        page,
        limit,
...
export default new ListarEnviosCampanha();
